...
- Portfolio - Showcasing all my work to date! Currently redesigning it while learning more about modern web tooling.

#### I'm Currently Learning
- Cloud architecture and deployment patterns
- Advanced TypeScript patterns and type-safe APIs
- System design principles

#### Previous Experience
- Software Engineering Intern @ Southern Glazer's
- Coding Instructor @ CodeArt

#### Open to New Opportunities
I'm currently open to new opportunities in software engineering. If you have an interesting role or project, feel free to reach out via the links below.
